            ...
            <div class="row mt-2">
                        ...
                        <div class="col col-lg-3">
                            <div class="card ml-2 mb-5 mr-2" >
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="https://wa.me/6285731240971?text=Saya%20mau%20pesan%20sepatu%20{{$pro->nama}}%20https://www.sepatualfatih.online" class="btn btn-success d-inline">WhatsApp</a>
                                </div>
                            </div>
                        </div>
                        @else
                ...
                <div class="col col-lg-3">
                    <div class="card ml-2 mb-5 mr-2">
                        ...
                        <a href="belanja/{{$pro->id}}" class="btn btn-primary">Beli</a>
                        <a href="https://wa.me/6285731240971?text=Saya%20mau%20pesan%20sepatu%20{{$pro->id}}%20https://www.sepatuindonesia.com/sepatu-wanita-casual/id/14068/sepatu-wanita-ks-870.html" class="btn btn-success d-inline">WhatsApp</a>
                        </div>
                    </div>
                </div>
                @endif
